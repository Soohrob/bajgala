...
- **Brevity rule**: the system prompt forces short default replies ("MATCH LENGTH TO THE MOMENT") — user feedback was that personas wrote essays for simple questions. Don't weaken this line.
